...
useSeoMeta({
  ...
  keywords:
    "skrmaster,首页,个人首页,个人网站,skr,threejs,nuxtjs,nuxt3,nuxt,vue,vue3,vue3+ts,ts,typescript,记录,博客,踩坑,前端,web开发,ssr,服务端渲染的个人网站,服务端渲染",
...
async function initCanvas() {
  ...
  man.y =
    windowWidth.value <= 992
      ? parkCanvas.height - man.height - 280 + man.stepYDiff / man.countY
      : parkCanvas.height - man.height - 320 + man.stepYDiff / man.countY;
  ...
  const lightImgData = await createImageBitmap(
    lightImg,
    0,
    0,
    lightImg.width,
            ...
            <div class="p-r p1">
              <div>
                <div style="width: 80px">
                  <img
                    src="@/assets/images/fangxiang.png"
                    style="
                      max-width: 100%;
                      max-height: 100%;
                      margin-top: -20px;
                ...
                <p class="detail fs24 my2">
                  专注于使用Vue、React进行开发
                  <br /><strong>中后台系统</strong
                  >开发、<strong>业务组件</strong>开发、
                  <strong>企业官网</strong>...
                </p>
              ...
              <div
                v-if="theme !== 'dark' && windowWidth > 1252"
                class="introduction__bg"
              ></div>
            </div>
          </div>
        </div>
        <div
          v-if="windowWidth > 578 && windowWidth < 992"
          class="introducion-seat"
        ></div>
      </div>
    </section>
